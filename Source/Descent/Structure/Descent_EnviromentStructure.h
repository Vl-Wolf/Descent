...
#include "Descent_EnviromentStructure.generated.h"

UCLASS()
class DESCENT_API ADescent_EnviromentStructure : public AActor, public IDescent_IGameActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ADescent_EnviromentStructure();

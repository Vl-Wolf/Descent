...
UCLASS()
class DESCENT_API UTypes : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable)
		static void AddEffectBySurfaceType(AActor* TakeEffectActor, FName BoneHit, TSubclassOf<UDescent_StateEffect> AddEffectClass, EPhysicalSurface SurfaceType);
};
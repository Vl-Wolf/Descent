...
#include "Descent/Character/Descent_InventoryComponent.h"
#include "Descent/Character/Descent_CharacterHealthComponent.h"
#include "Descent/Interface/Descent_IGameActor.h"
#include "Descent/StateEffects/Descent_StateEffect.h"
#include "Descent_Character.generated.h"

UCLASS(Blueprintable)
class ADescent_Character : public ACharacter, public IDescent_IGameActor
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Inventory", meta = (AllowPrivateAccess = "true"))
		class UDescent_InventoryComponent* InventoryComponent;
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Health", meta = (AllowPrivateAccess = "true"))
		class UDescent_CharacterHealthComponent* HealthComponent;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Ability")
		TSubclassOf<UDescent_StateEffect> AbilityEffect;
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure)
		TArray<UDescent_StateEffect*> GetCurrentEffectsOnChar();
	UFUNCTION(BlueprintCallable, BlueprintPure)
